    ...
    <div>
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Are you a developer?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Get API without coding
          </h1>
          <p class="leading-normal text-2xl mb-8">
            Tell us your requirement and we will build one for you.
          </p>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="@/assets/images/wesbite/undraw_start_building_vqhd.svg" />
        </div>
      </div>
    </div>
    <!-- Hero Ends -->
          ...
          <div class="flex-1 mb-6">
            ...
            <a class="text-orange-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
              ...
              <svg class="h-8 fill-current inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.005 512.005">
                <rect x="16.539" y="425.626" width="479.767" height="50.502" transform="matrix(1,0,0,1,0,0)"
                  fill="rgb(0,0,0)" />
