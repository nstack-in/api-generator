<template>
    <div class="container">
        ...
        <div class="my-4" v-if="!loading">
            <div class=" row">
                <div class="col-lg-6 col-sm-12 pb-2" v-if="Object.keys(projects.data).length == 3" lg="6" sm="12"
                    cols="sm">
                ...
                <div class="col-lg-6 col-sm-12 pb-2" v-for="(item, index) in projects.data" :key="index">
                    ...
                    <div class="card" style="min-height:150px">
                        <div class="card-header">
                            <div class="card-title d-flex mb-0">
                                ...
                                <router-link class="ml-auto btn btn-secondary"
